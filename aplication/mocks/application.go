...
import (
	...
	aplication "github.com/Soter-Tec/go-hexagonal/aplication"
...
func (m *MockProductServiceInterface) Create(name string, price float64) (aplication.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductReader) Get(id string) (aplication.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(aplication.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get mocks base method.
func (m *MockProductPersistenceInterface) Get(id string) (aplication.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(aplication.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(product aplication.ProductInterface) (aplication.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(aplication.ProductInterface)
	ret1, _ := ret[1].(error)
